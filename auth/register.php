...
<!-- condition to make user can register and join to databases as new user -->
<?php

// condition if user had empty input when click submit(register) button then give an allert
if(isset($_POST['submit'])) {

  if(empty($_POST['username']) 
    OR empty($_POST['email']) 
    OR empty($_POST['password'])) {
    echo "<script>alert('one or more inputs are empty please check it again');</script>";
  } else {
